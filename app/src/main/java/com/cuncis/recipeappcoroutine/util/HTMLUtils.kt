...
object HTMLUtils {
    ...
    fun setTextViewHTML(mContext: Context, text: TextView, html: String?) {
        val sequence =
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Html.fromHtml(html, Html.FROM_HTML_MODE_COMPACT, HtmlGetterImage(mContext, text), null)
            } else {
    ...
    class HtmlGetterImage internal constructor(private val context: Context, private val textView: TextView) : Html.ImageGetter {
